...
z_range = 7e-3  # 5 mm in y-direction
Nx = 200  # Number of grid points in x-direction
Nz = 70  # Number of grid points in y-direction
frequency = 22e9  # Frequency
...
# Define structure
solver.add_object(-1e8, 1, x_indices=[176], z_indices=range(0, 6))
...
solver.add_UPML(pml_width=70, sigma_max=5)
