...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent) {
    setWindowTitle(QStringLiteral("FEM Waveguide Scattering Viewer (native Qt)"));
    resize(1360, 860);
    buildUi();
}
...
void MainWindow::chooseDirectory() {
    const auto directory = QFileDialog::getExistingDirectory(
        this, QStringLiteral("Choose directory containing FEM Waveguide Scattering HDF5 results"));
