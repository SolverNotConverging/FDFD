r"""Metal presets for the good-conductor surface-impedance approximation.
...
def canonical_metal_name(metal: str) -> str:
    ...
    try:
        ...
        raise ValueError(f"Unknown metal {metal!r}; supported metals: {supported}.") from None
...
def good_conductor_surface_impedance(
    ...
    ----------
    metal:
        A supported full name or chemical-symbol alias.
    frequency_hz:
        Positive frequency in hertz.
    relative_permeability:
        Positive real relative permeability.  It defaults to one.
    """
