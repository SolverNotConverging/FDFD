fdfd_scattering Solver 2D
===========================

``ScatteringSolver2D`` solves two-dimensional frequency-domain scattering problems on a Yee grid. It supports scalar TEz and TMz total-field/scattered-field formulations with plane-wave or point-source excitation.
...
.. code-block:: python
   ...
   import numpy as np
   from Scattering_Solver_2D import ScatteringSolver2D

   f0 = 10e9
   wavelength = 299792458 / f0
   sim = ScatteringSolver2D(f0, 6 * wavelength, 6 * wavelength, 300, 300)
