...
from fem_waveguide_modes import Rectangle, good_conductor_surface_impedance
from solvers.fem.waveguide_modes.examples.microstrip_sibc import (
    COPPER_THICKNESS,
    DOMAIN_X,
    FREQUENCY,
    MESH_OPTIONS,
...
def test_microstrip_example_solves_a_passive_quasi_tem_mode() -> None:
    solver = build_solver()
    solver.mesh(**MESH_OPTIONS)
    mode = solver.solve(
        max_refinements=0,
        num_modes=1, neff_guess=1.65,
