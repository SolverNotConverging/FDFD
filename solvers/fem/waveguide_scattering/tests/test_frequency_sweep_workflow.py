...
def _uniform_simulation(frequency_hz: float) -> wf.WaveguideScatteringSolver2D:
    simulation = wf.WaveguideScatteringSolver2D(frequency=frequency_hz, ky=0.0, x_range=(0.0, 1e-06), z_range=(-3e-06, 3e-06), background_epsilon=1.0, transverse_boundary='pec')
