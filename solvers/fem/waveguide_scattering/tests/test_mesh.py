...
from fem_waveguide_scattering.exceptions import ConfigurationError, MeshError
...
def test_scattering_mesh_preserves_global_cap_and_adds_dielectric_target() -> None:
    ...
    simulation.add_rectangle(x_range=(0.0, 0.3), z_range='all', epsilon=4.0, background=True, name='dielectric')
