...
from solvers.fem.waveguide_scattering.examples.grounded_slab_slot import MM, build_simulation
...
def test_high_level_pec_api_accepts_only_compact_actual_only_sheet() -> None:
    simulation = wf.WaveguideScatteringSolver2D(frequency=10000000000.0, x_range=(-10.0 * MM, 10.0 * MM), z_range=(-20.0 * MM, 20.0 * MM), transverse_boundary='pec')
