...
OUTPUT = Path(__file__).resolve().parents[3] / "outputs/examples/fdfd/periodic_modes/image_guide_leaky_wave_antenna_3d_dispersion"


def main():
    spec = importlib.util.spec_from_file_location("guide_example", Path(__file__).with_name("image_guide_leaky_wave_antenna_3d.py"))
