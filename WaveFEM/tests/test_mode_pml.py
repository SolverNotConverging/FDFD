...
def test_outgoing_transverse_pml_has_passive_minus_iwt_stretch_sign() -> None:
    """Positive Im(sx) must produce positive Im(beta) for exp(-i*omega*t)."""
