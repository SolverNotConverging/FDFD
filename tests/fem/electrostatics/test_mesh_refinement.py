...
def test_high_dk_region_receives_smaller_gmsh_elements() -> None:
    ...
    solver.add_geometry(name='high_dk', material=materials.Material(epsilon=((16.0, 0.0), (0.0, 1.0)), mu=1.0), shape=shapes.Rectangle(bounds=((1.0, 2.0), (0.0, 1.0))))
...
def test_dirichlet_boundary_refinement_reduces_near_boundary_size() -> None:
    ...
    solver.set_potential(potential=1.0, name='electrode', geometry=shapes.Rectangle(bounds=((0.45, 0.55), (0.2, 0.8))))
